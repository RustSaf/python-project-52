...
#    author = Users.get_username
    name = models.TextField(max_length=150, verbose_name=_('Name'))
    discription = models.CharField('discription', max_length=100)
    status = models.ForeignKey(Statuses, on_delete=models.PROTECT, blank=True, null=True, verbose_name="Status")
    executor = models.ForeignKey(Users, on_delete=models.PROTECT, blank=True, null=True, verbose_name="Executor")
    label = models.ManyToManyField(Labels, blank=True, verbose_name="Labels")
